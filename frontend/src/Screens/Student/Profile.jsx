...
const Profile = () => {
  ...
  const checkPasswordHandler = (e) => {
    ...
    axios
      .post(`${baseApiURL()}/student/auth/login`, {
  ...
  const changePasswordHandler = (id) => {
    axios
      .put(`${baseApiURL()}/student/auth/update/${id}`, {
        loginid: router.state?.loginid,
  ...
  return (
    <div className="w-full mx-auto my-8 flex justify-between items-start">
      {data && typeof data === "object" && data.firstName ? (
        <>
          <div>
            <p className="text-2xl font-semibold">
              Hello {data.firstName} {data.middleName || ""} {data.lastName} 👋
            ...
            <div className="mt-3">
              ...
              <p className="text-lg mb-2">Phone: +91 {data.phoneNumber}</p>
